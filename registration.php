...
<body class="bg-light">
 ...
 // Real-time emailname validation using AJAX
  const checkEmailnameAvailability = (emailField) => {
    emailField.addEventListener('input', () => {
      ...
      // Send AJAX request to check emailname availability
  ...
  checkEmailnameAvailability(email);
